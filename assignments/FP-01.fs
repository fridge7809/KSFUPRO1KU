...
// 1.3 (1.2) Declare a function h: float * float -> float

let h (x:float, y:float) =
    System.Math.Sqrt (x**2 + y**2)
    
//1.4 (1.3) Write function expressions corresponding to the functions g and h in the exercises 1.1 and 1.2.
// g
fun n -> n +4
// h
...
// (float * float -> float) is a function taking a tuple of float and float as input and returns float
